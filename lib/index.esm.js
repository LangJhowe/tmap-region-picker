...
const Picker = (props) => {
    ...
    return (React.createElement("div", { className: clsArr.join(' ') },
        React.createElement("div", { className: "tmap-region-picker__cascader" },
            React.createElement(Select, { placeholder: "\u8BF7\u9009\u62E9\u7701\u4EFD" }),
            React.createElement(Select, { placeholder: "\u8BF7\u9009\u62E9\u57CE\u5E02" }),
            React.createElement(Select, { placeholder: "\u8BF7\u9009\u62E9\u533A" })),
        React.createElement("div", { className: "tmap-region-picker__map-container" },
            React.createElement("div", { className: "tmap-region-picker__map", id: id }))));
};
