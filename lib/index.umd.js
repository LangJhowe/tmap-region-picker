(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["tmap-region-picker"] = {}, global.React, global.antd));
  ...
  function loadTMapApi(cfg) {
      return new Promise((resolve, reject) => {
          ...
          if (tScript) {
              ...
              const script = (_a = globalThis.document) === null || _a === void 0 ? void 0 : _a.createElement('script');
              if (!script)
                  resolve(undefined);
              ...
              (_b = globalThis.document) === null || _b === void 0 ? void 0 : _b.body.appendChild(script);
          }
      });
  }
  function getCityNameByIP() {
      // return Promise.resolve()
      return axios.get('https://location.tianditu.gov.cn/data/getCityName').then((res) => {
  ...
  var css$1 = ".tmap-region-picker__map {\n  width: 400px;\n  height: 300px;\n}\n";
  n(css$1,{});
  ...
  const Picker = (props) => {
      ...
      React.useEffect(() => {
          ...
          loadTMapApi(config).then(res => {
              (res === null || res === void 0 ? void 0 : res.T) && setT(res === null || res === void 0 ? void 0 : res.T);
          });
      }, []);
      React.useEffect(() => {
          if (T) {
      ...
      return (React__default["default"].createElement("div", { className: clsArr.join(' ') },
          React__default["default"].createElement("div", { className: "tmap-region-picker__cascader" },
              React__default["default"].createElement(antd.Select, { placeholder: "\u8BF7\u9009\u62E9\u7701\u4EFD" }),
              React__default["default"].createElement(antd.Select, { placeholder: "\u8BF7\u9009\u62E9\u57CE\u5E02" }),
              React__default["default"].createElement(antd.Select, { placeholder: "\u8BF7\u9009\u62E9\u533A" })),
          React__default["default"].createElement("div", { className: "tmap-region-picker__map-container" },
              React__default["default"].createElement("div", { className: "tmap-region-picker__map", id: id }))));
  };

  var css = ".tmap-region-picker__map {\n  width: 400px;\n  height: 300px;\n}\n";
  n(css,{});
